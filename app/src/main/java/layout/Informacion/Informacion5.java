...
public class Informacion5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View obj=inflater.inflate(R.layout.informacion_imagen5, container, false);
        mVrPanoramaView = (VrPanoramaView) obj.findViewById(R.id.imagen5_vr);
        cargar();
