...
public class Informacion4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View obj=inflater.inflate(R.layout.informacion_imagen4, container, false);
        mVrPanoramaView = (VrPanoramaView) obj.findViewById(R.id.imagen4_vr);
        cargar();
