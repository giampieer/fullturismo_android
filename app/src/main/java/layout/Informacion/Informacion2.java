...
public class Informacion2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View obj=inflater.inflate(R.layout.informacion_imagen2, container, false);
        mVrPanoramaView = (VrPanoramaView) obj.findViewById(R.id.imagen2_vr);
        cargar();
