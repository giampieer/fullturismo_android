...
import layout.Adapter.Adapter_imagenes2;
 ...
 */
public class Fragment_imagenes2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View obj=inflater.inflate(R.layout.layout2, container, false);
    ...
    class Async_Listar_Proyectos extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... obj) {
            ...
            //1 - Nacional
            //2 - Internacional
            listado = objdao.ListarLugares("2");
