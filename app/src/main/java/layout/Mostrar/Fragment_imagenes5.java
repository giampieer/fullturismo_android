...
import layout.Adapter.Adapter_imagenes5;
import principal.android.empresa.vr_proyecto.R;

/**
 * A simple {@link Fragment} subclass.
 */
public class Fragment_imagenes5 extends Fragment {
String[] listado=new  String[]{"andes.jpg","IMAGEN 2","MAGEN 3","IMAGEN 4"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View obj=inflater.inflate(R.layout.layout5, container, false);
    ...
    class Async_Listar_Proyectos extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... obj) {
            ...
            conexion = mensaje;
                ...
                adapter=new Adapter_imagenes5(listado,getActivity());
            return mensaje;
        }
