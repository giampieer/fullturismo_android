...
public class Adapter_imagenes1 extends RecyclerView.Adapter<Adapter_imagenes1.ViewHolderproyecto_Menu_Principal> {
    ...
    public Adapter_imagenes1(ArrayList<LugaresBean> lista, Context context1) {
        listado = lista;
        context = context1;
    }
    ...
    public Adapter_imagenes1.ViewHolderproyecto_Menu_Principal onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_imagenes1, parent, false);
        Adapter_imagenes1.ViewHolderproyecto_Menu_Principal viewHolder = new Adapter_imagenes1.ViewHolderproyecto_Menu_Principal(view);
    ...
    public void onBindViewHolder(Adapter_imagenes1.ViewHolderproyecto_Menu_Principal holder, final int position) {

//        holder.texto.setText(listado[position]);
//        //libreria picasso
//        String[] lista=new String[]{"http://farm7.static.flickr.com/6100/6344276825_f03d679f08_b.jpg",
//                "http://enviajes.cl/wp-content/uploads/2013/10/Lugares-turisticos-de-Peru-Valle-Incas.jpg",
//                "http://www.acuariustravel.com/wp-content/uploads/2015/02/plaza-de-armas-de-arequipa.jpg",
//                "http://graphics8.nytimes.com/newsgraphics/2015/01/08/places-to-go/assets/images/peru-1600.jpg"};
//        Picasso.with(context).load(lista[position]).into(holder.imagen);
    ...
    @Override
    public void onViewAttachedToWindow(Adapter_imagenes1.ViewHolderproyecto_Menu_Principal holder) {
    ...
    public static class ViewHolderproyecto_Menu_Principal extends RecyclerView.ViewHolder {
        ...
        public ViewHolderproyecto_Menu_Principal(View itemView1) {
            ...
            texto = (TextView) itemView1.findViewById(R.id.texto_menu_principal1);
            cardView = (CardView) itemView1.findViewById(R.id.cardview_menu_principal1);
            relativo = (RelativeLayout) itemView1.findViewById(R.id.relative_menu_principal1);
